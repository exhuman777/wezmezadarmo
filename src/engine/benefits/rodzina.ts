...
export const RODZINA: Benefit[] = [
  ...
  {
    id: 'zasilek-rodzinny', nazwa: 'Zasiłek rodzinny z dodatkami',
    opis: 'Zasiłek rodzinny to świadczenie dla rodzin o niższych dochodach (inaczej niż 800+, które jest bez progu). Kryterium dochodowe: 674 PLN netto na osobę w rodzinie, lub 764 PLN, jeśli w rodzinie jest dziecko z orzeczeniem o niepełnosprawności. Obowiązuje zasada "złotówka za złotówkę": przekroczenie progu nie odbiera świadczenia całkowicie, kwota jest pomniejszana o nadwyżkę. Sam zasiłek zależy od wieku dziecka: 95 PLN miesięcznie na dziecko do 5 lat, 124 PLN na dziecko 5-18 lat, 135 PLN na dziecko 18-24 lata (jeśli się uczy). Prawdziwa wartość tkwi w dodatkach do zasiłku, które przysługują tylko osobom mającym prawo do zasiłku rodzinnego: dodatek z tytułu urodzenia dziecka (1000 PLN jednorazowo), z tytułu opieki nad dzieckiem w okresie urlopu wychowawczego (400 PLN miesięcznie), z tytułu samotnego wychowywania dziecka (193 PLN na dziecko, max 386 PLN), z tytułu wychowywania dziecka w rodzinie wielodzietnej (95 PLN na trzecie i każde kolejne dziecko), z tytułu kształcenia i rehabilitacji dziecka niepełnosprawnego (90 PLN do 5 lat, 110 PLN powyżej), z tytułu rozpoczęcia roku szkolnego (100 PLN raz w roku), z tytułu nauki dziecka poza miejscem zamieszkania (69 PLN na pokrycie dojazdu lub 113 PLN na zamieszkanie poza domem). Wniosek SR-1 składa się w gminie lub MOPS. Okres zasiłkowy trwa od 1 listopada do 31 października, wnioski od 1 lipca (elektronicznie) lub 1 sierpnia (papierowo).',
    kategoria: 'RODZINA',
    kwota: '95-135 PLN miesięcznie na dziecko + dodatki (100-1000 PLN)',
    kwotaMin: 95, kwotaMax: 1000,
    czestotliwosc: 'miesięcznie (zasiłek), różnie (dodatki)',
    wymagania: { dzieci: { min: 1, wiekMax: 24 }, dochodMax: 674 },
    wykluczenia: [
      { opis: 'Dochód na osobę w rodzinie przekracza 674 PLN netto (764 PLN przy dziecku z niepełnosprawnością) wraz z zasadą złotówka za złotówkę', sprawdz: 'dochod_zasilek_rodzinny' },
    ],
    wniosek: {
      kanal: ['URZAD_GMINY', 'MOPS', 'EMPATIA'], formularz: 'SR-1 (zasiłek rodzinny) + załączniki na dodatki',
      dokumenty: [
        'Wniosek SR-1',
        'Dokumenty potwierdzające dochody rodziny (PIT, zaświadczenia)',
        'Akty urodzenia dzieci',
        'Zaświadczenie ze szkoły/uczelni (dzieci 18-24 lata)',
        'Orzeczenie o niepełnosprawności dziecka (jeśli dotyczy dodatku)',
      ],
      kroki: [
        'Policz dochód netto na osobę w rodzinie (próg 674 PLN, lub 764 PLN z dzieckiem niepełnosprawnym)',
        'Wypełnij wniosek SR-1 i zaznacz dodatki, które Ci przysługują',
        'Złóż w gminie/MOPS od 1 sierpnia lub elektronicznie przez Empatię od 1 lipca',
        'Dołącz dokumenty dochodowe i akty urodzenia dzieci',
        'Gmina wyda decyzję i wypłaci zasiłek z dodatkami co miesiąc',
      ],
      terminRealizacji: '30 dni od złożenia kompletnego wniosku',
      pulapki: [
        'Zasiłek rodzinny to nie to samo co 800+, ma kryterium dochodowe i jest dużo niższy',
        'Główna korzyść to dodatki, które przysługują tylko przy prawie do zasiłku rodzinnego',
        '"Złotówka za złotówkę": niewielkie przekroczenie progu nie odbiera całego świadczenia',
        'Okres zasiłkowy: 1 listopada - 31 października, składaj wniosek wcześnie',
        'Dodatek z tytułu urodzenia dziecka (1000 PLN) to osobne świadczenie niż becikowe',
      ],
      odwolanie: 'Odwołanie do Samorządowego Kolegium Odwoławczego w ciągu 14 dni od decyzji',
    },
  ...
  },
  {
    ...
    opis: 'Jednorazowe świadczenie "Za życiem" to 4000 PLN wypłacane z tytułu urodzenia żywego dziecka z ciężkim i nieodwracalnym upośledzeniem albo nieuleczalną chorobą zagrażającą życiu, które powstały w prenatalnym okresie rozwoju dziecka lub w czasie porodu. Co ważne, świadczenie nie ma żadnego kryterium dochodowego, przysługuje niezależnie od zarobków rodziny. Przysługuje matce, ojcu, opiekunowi prawnemu lub opiekunowi faktycznemu dziecka. Kluczowy wymóg: zaświadczenie lekarza ubezpieczenia zdrowotnego, posiadającego specjalizację II stopnia lub tytuł specjalisty w dziedzinie położnictwa i ginekologii, perinatologii, neonatologii lub pediatrii, potwierdzające ciężkie i nieodwracalne upośledzenie lub nieuleczalną chorobę. Drugi wymóg: matka musiała pozostawać pod opieką medyczną nie później niż od 10 tygodnia ciąży do porodu (nie dotyczy opiekunów prawnych/faktycznych ani przysposabiających). Wniosek SZŻ składa się w gminie lub MOPS w ciągu 12 miesięcy od urodzenia dziecka, po tym terminie prawo wygasa. Świadczenie jest częścią szerszego programu "Za życiem", który obejmuje też m.in. dostęp do koordynowanej opieki, wsparcie asystenta rodziny i pomoc w opiece.',
    kategoria: 'RODZINA',
    kwota: '4000 PLN jednorazowo (bez kryterium dochodowego)',
    kwotaMin: 4000, kwotaMax: 4000,
    czestotliwosc: 'jednorazowo',
    wymagania: { dzieci: { min: 1, wiekMax: 1 } },
    wykluczenia: [
      { opis: 'Brak zaświadczenia lekarza specjalisty o ciężkim nieodwracalnym upośledzeniu lub nieuleczalnej chorobie powstałej w okresie prenatalnym lub przy porodzie', sprawdz: 'zaswiadczenie_lekarskie_za_zyciem' },
      { opis: 'Matka nie pozostawała pod opieką medyczną od 10 tygodnia ciąży (nie dotyczy opiekunów i przysposabiających)', sprawdz: 'opieka_medyczna_10_tydzien' },
      { opis: 'Wniosek złożony po upływie 12 miesięcy od urodzenia dziecka', sprawdz: 'termin_12_miesiecy' },
    ],
    wniosek: {
      kanal: ['URZAD_GMINY', 'MOPS'], formularz: 'SZŻ (wniosek o jednorazowe świadczenie Za życiem)',
      dokumenty: [
        'Wniosek SZŻ',
        'Zaświadczenie lekarza ubezpieczenia zdrowotnego o ciężkim i nieodwracalnym upośledzeniu lub nieuleczalnej chorobie dziecka',
        'Zaświadczenie o pozostawaniu matki pod opieką medyczną od 10 tygodnia ciąży',
        'Akt urodzenia dziecka',
        'Dowód osobisty wnioskodawcy',
      ],
      kroki: [
        'Uzyskaj zaświadczenie od lekarza specjalisty (położnictwo, perinatologia, neonatologia lub pediatria)',
        'Przygotuj zaświadczenie o opiece medycznej matki od 10 tygodnia ciąży',
        'Wypełnij wniosek SZŻ',
        'Złóż w gminie lub MOPS w ciągu 12 miesięcy od urodzenia dziecka',
        'Gmina wyda decyzję i wypłaci 4000 PLN',
      ],
      terminRealizacji: '30 dni od złożenia kompletnego wniosku',
      pulapki: [
        'BRAK kryterium dochodowego, przysługuje każdej rodzinie spełniającej warunki medyczne',
        'Kluczowe jest zaświadczenie lekarza specjalisty, zwykłe orzeczenie o niepełnosprawności nie wystarcza',
        'Wniosek trzeba złożyć w ciągu 12 miesięcy od urodzenia, potem prawo przepada',
        'To część szerszego programu "Za życiem" (opieka koordynowana, asystent rodziny)',
      ],
      odwolanie: 'Odwołanie do Samorządowego Kolegium Odwoławczego w ciągu 14 dni od decyzji',
    },
