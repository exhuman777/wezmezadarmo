      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-[14px] sm:text-[15px] leading-[1.7] text-text-2">
          ...
          <Section n="4" title="Zastrzeżenia dotyczące sztucznej inteligencji">
            ...
            <P>4.4. Transparentność AI: wszystkie treści wygenerowane przez model AI są wyraźnie oznaczone etykietą &quot;AI&quot; w interfejsie użytkownika. Baza 104 świadczeń jest ręcznie zweryfikowana przez człowieka. AI pełni wyłącznie rolę pomocniczą (weryfikacja dopasowań, asystent czatowy).</P>
