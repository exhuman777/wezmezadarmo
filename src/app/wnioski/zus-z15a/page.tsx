...
const FIELD_MAP: Partial<Record<keyof Z15aData, string>> = {
  imie: 'imie',
  nazwisko: 'nazwisko',
  pesel: 'pesel',
  ulica: 'ulica',
...
export default function ZusZ15aPage() {
  ...
  const { data, setData, prefillStatus, prefillCount, isLoggedIn } = useFormPrefill<Z15aData>('zus-z15a', EMPTY, FIELD_MAP);
